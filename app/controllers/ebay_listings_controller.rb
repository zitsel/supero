class EbayListingsController < ApplicationController
  ...
  def create
    listing_info=EbayHelper::Ebay::AddItem(params[:listing_type],params[:duration],params[:quantity],params[:condition_id],params[:free_shipping],params[:start_price],params[:buy_it_now_price],params[:product_id],params[:description].squish,params[:ebay_title])
