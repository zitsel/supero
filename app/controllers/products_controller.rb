class ProductsController < ApplicationController
  ...
  def ebay_post
    ebay_id=EbayHelper::Ebay::AddItem(product_params)
    redirect_to products_path, notice: "#{ebay_id}"
  end
  # GET /products/1
  # GET /products/1.json
  def show
    @images=type_class.find(params[:id]).uploads
  end
