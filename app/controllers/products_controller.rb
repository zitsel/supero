class ProductsController < ApplicationController
  ...
  def ebay_post
    ebay_id=EbayHelper::Ebay::AddItem(params[:listing_type],params[:duration],params[:quantity],params[:condition_id],params[:free_shipping],params[:start_price],params[:buy_it_now_price],params[:id])
    redirect_to products_path, notice: "#{ebay_id}"
  end
  # GET /products/1
  # GET /products/1.json
  def show
